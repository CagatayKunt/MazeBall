...
namespace qtools.qmaze
{
	...
	public class QMazeEngineInspector: Editor 
	{
		...
		private void OnEnable() 
		{
			...
			proNote = QInspectorUtils.getAsset<Texture2D>("ProNote t:texture2D");
		...
		private void initStyle()
		{
			...
			proStyle = new GUIStyle(GUI.skin.label);
			proStyle.padding = new RectOffset(0, 0, 0, 0);
		}
		...
		{
			if (GUILayout.Button(proNote, proStyle, GUILayout.Width(proNote.width), GUILayout.Height(proNote.height)))
			{
				Application.OpenURL("com.unity3d.kharma:content/30600");
			}
		}
